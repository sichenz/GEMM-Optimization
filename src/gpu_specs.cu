...
// Collect GPU specifications and calculate performance limits
// This helps us understand what performance we should expect
...
// Needed to calculate peak FP32 performance
